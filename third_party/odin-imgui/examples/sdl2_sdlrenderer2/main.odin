...
// This is an example of using the bindings with SDL2 and SDL_Renderer2
...
// TODO: This has been the case for a long time: the bindings should be updated, or this backend should be removed.
